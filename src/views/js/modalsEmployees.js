document.addEventListener("DOMContentLoaded", function () {
  // Agregar empleado
  document
    .getElementById("agregarEmpleado")
    .addEventListener("click", function () {
      var agregarEmpleadoModal = new bootstrap.Modal(
        document.getElementById("agregarEmpleadoModal"),
      );
  ...
  eliminarBotones.forEach(function (boton) {
    boton.addEventListener("click", function () {
      ...
      var eliminarEmpleadoModal = new bootstrap.Modal(
        document.getElementById("eliminarEmpleadoModal"),
      );
      eliminarEmpleadoModal.show();

      var cancelarBoton = document.querySelector(
        "#eliminarEmpleadoModal .btn-secondary",
      );
    ...
    boton.addEventListener("click", function () {
      ...
      fetch("/src/controllers/getEmployee.php?employee_id=" + empleadoId)
        ...
        .then((data) => {
          ...
          var editarEmpleadoModal = new bootstrap.Modal(
            document.getElementById("editarEmpleadoModal"),
          );
