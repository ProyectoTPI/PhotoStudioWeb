...
<body>
    ...
    <section class="sidebar">
        ...
        <ul>
            ...
            <li><a href="#"><i class="fa fa-shopping-bag"></i>Identidad empresarial</a></li>
            <li><a href="#"><i class="fa fa-calendar"></i>Agenda</a></li>
            <li><a href="#"><i class="fa fa-link"></i>Empleados</a></li>
            <li><a href="#"><i class="fa fa-cog"></i>Directorio telefónico</a></li>
            <li><a href="#"><i class="fa fa-question-circle-o"></i>Dashboard</a></li>
            <li><a href="#"><i class="fa fa-envelope-o"></i>Sobre nosotros</a></li>
        </ul>
    </section>
