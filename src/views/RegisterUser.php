      ...
      <div class="card-body m-3">
        ...
        <form action="/src/controllers/RegController.php" method="post">
          <div class="form-group m-2">
            ...
            <input type="name" class="form-control" name="name" id="name" placeholder="Ingrese el nombre usuario" Required>
          ...
          <div class="form-group m-2">
            ...
            <input type="text" class="form-control" id="dui" name="dui" placeholder="Ingrese su # de Documento Único de Identidad" Required>
          </div>
          <div class="form-group m-2">
